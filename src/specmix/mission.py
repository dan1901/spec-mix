...
class MissionManager:
    ...
    def __init__(self, locales_dir: Optional[Path] = None, locale: str = 'en'):
        ...
        # Fallback to .spec-mix/missions for backward compatibility
        self.specmix_missions_dir = Path('.spec-mix') / 'missions'
    ...
    def get_missions_dir(self) -> Path:
        ...
        elif self.specmix_missions_dir.exists():
            return self.specmix_missions_dir
        else:
    ...
    def get_active_mission(self) -> str:
        ...
        """
        # Check for active-mission marker in .spec-mix/
