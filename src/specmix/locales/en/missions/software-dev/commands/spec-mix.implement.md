...
3. Load and analyze the implementation context:
   ...
   - **CONSTITUTION**: If `.spec-mix/memory/constitution.md` exists, read it to ensure implementation follows project principles (code quality, testing standards, architectural constraints)
