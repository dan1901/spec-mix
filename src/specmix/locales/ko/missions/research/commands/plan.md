...
2. **컨텍스트 로드**: FEATURE_SPEC 및 `specs/constitution.md` 읽기 (존재하는 경우). `.spec-mix/active-mission/templates/plan-template.md`에서 IMPL_PLAN 템플릿 로드.
...
3. **연구 결과 통합** `research.md`에 다음 형식 사용:
   - 결정: [선택된 것]
   - 근거: [선택된 이유]
   - 고려된 대안: [평가된 다른 것]
