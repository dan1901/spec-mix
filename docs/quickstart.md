...
```bash
uvx --from git+https://github.com/dan1901/spec-kit.git spec-mix init <PROJECT_NAME> --script ps  # Force PowerShell
uvx --from git+https://github.com/dan1901/spec-kit.git spec-mix init <PROJECT_NAME> --script sh  # Force POSIX shell
```
