...
<p align="center">
    <a href="{{REPO_URL}}/actions/workflows/release.yml"><img src="{{REPO_URL}}/actions/workflows/release.yml/badge.svg" alt="Release"/></a>
    <a href="{{REPO_URL}}/stargazers"><img src="https://img.shields.io/github/stars/{{REPO_SLUG}}?style=social" alt="GitHub stars"/></a>
    <a href="{{REPO_URL}}/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="License"/></a>
    <a href="{{PAGES_URL}}/"><img src="https://img.shields.io/badge/docs-GitHub_Pages-blue" alt="Documentation"/></a>
</p>
...
```bash
uv tool install spec-mix --from git+{{REPO_URL}}.git
...
```bash
uv tool install spec-mix --force --from git+{{REPO_URL}}.git
...
```bash
uvx --from git+{{REPO_URL}}.git spec-mix init <PROJECT_NAME>
