...
/spec-mix.spec-mix Real-time chat system with message history and user presence
...
/spec-mix.plan WebSocket for real-time messaging, PostgreSQL for history, Redis for presence
